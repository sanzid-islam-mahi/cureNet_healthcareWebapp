...
export const schemas = {
  ...
  User: {
    ...
    properties: {
      ...
      clinic: { $ref: '#/components/schemas/ClinicSummary' },
  ...
  MedicalImagingRecord: {
    ...
    properties: {
      ...
      sourceType: { type: 'string', enum: ['provider', 'external'] },
      ...
      status: { type: 'string', enum: ['available', 'archived'] },
  ...
  AdminUser: {
    ...
    properties: {
      ...
      gender: { type: 'string', nullable: true },
      address: { type: 'string', nullable: true },
      role: { type: 'string', enum: ['admin', 'patient', 'doctor', 'receptionist'] },
  ...
  AdminUserUpsert: {
    ...
    properties: {
      ...
      department: { type: 'string', nullable: true },
      experience: { type: 'integer', nullable: true },
      clinicId: { type: 'integer', nullable: true, description: 'Required for receptionist users and required before doctor verification.' },
      employeeCode: { type: 'string', nullable: true },
      verified: { type: 'boolean', nullable: true },
    },
  },
  ClinicRecord: {
    ...
    properties: {
      ...
      notes: { type: 'string', nullable: true },
      doctorCount: { type: 'integer', nullable: true },
      doctors: {
        type: 'array',
        nullable: true,
        items: {
